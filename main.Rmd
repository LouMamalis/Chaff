...
# **Introduction** 
 ...
 The male and female birds look very different to each other. The male chaffinch is much more colourful and bright as shown in \@ref(tab:chaff-male-fig). Figure 2 shows the duller, less colourful female chaffinch. 

(ref:male-chaff-fig) This is a nice colourful male chaffinch. By Photo © Wikipedia, https://en.wikipedia.org/wiki/Common_chaffinch#/media/File:Chaffinch_(#Fringilla_coeleb
